...
},{"../Data.Foldable/index.js":"../output/Data.Foldable/index.js","../Data.Generic.Rep/index.js":"../output/Data.Generic.Rep/index.js","../Data.Monoid/index.js":"../output/Data.Monoid/index.js","../Data.Semigroup/index.js":"../output/Data.Semigroup/index.js","../Data.Show/index.js":"../output/Data.Show/index.js","../Data.Symbol/index.js":"../output/Data.Symbol/index.js"}],"../output/Effect.Console/foreign.js":[function(require,module,exports) {
"use strict";
...
},{"./foreign.js":"../output/Graphics.Canvas/foreign.js","../Control.Apply/index.js":"../output/Control.Apply/index.js","../Data.Eq/index.js":"../output/Data.Eq/index.js","../Data.Functor/index.js":"../output/Data.Functor/index.js","../Data.Maybe/index.js":"../output/Data.Maybe/index.js","../Data.Show/index.js":"../output/Data.Show/index.js","../Effect/index.js":"../output/Effect/index.js","../Effect.Exception.Unsafe/index.js":"../output/Effect.Exception.Unsafe/index.js"}],"../output/Web.TouchEvent.Touch/foreign.js":[function(require,module,exports) {
"use strict";
...
var reflectPoint = function reflectPoint(v) {
  return function (v1) {
    ...
    ;
    throw new Error("Failed pattern match at Main (line 379, column 1 - line 379, column 38): " + [v.constructor.name, v1.constructor.name]);
  };
};
...
var makeSwipe = function makeSwipe(m$primestart) {
  return function (end) {
    return Control_Bind.bind(Data_Maybe.bindMaybe)(m$primestart)(function (start) {
      ...
      ;
      throw new Error("Failed pattern match at Main (line 209, column 3 - line 214, column 29): " + [Data_Unit.unit.constructor.name]);
    });
  };
};
  ...
  return function (keyboard) {
    ...
    var toPress = function toPress(event) {
      return Data_Functor.mapFlipped(FRP_Event.functorEvent)(event)(function (sw) {
        ...
        ;
        throw new Error("Failed pattern match at Main (line 234, column 39 - line 238, column 28): " + [sw.constructor.name]);
      });
    };
    ...
    var noTouch = Data_Functor.map(FRP_Event.functorEvent)(touchToPos)(Data_Filterable.filterMap(FRP_Event.filterableEvent)(function (te) {
      var $80 = Web_TouchEvent_TouchList.length(Web_TouchEvent_TouchEvent.touches(te)) === 0;
    ...
    var getDiff = function getDiff(v) {
      return Data_Functor.map(Data_Maybe.functorMaybe)(function () {
        var $140 = Data_Time_Duration.negateDuration(Data_Time_Duration.durationMilliseconds);
        return function ($141) {
          return function (v1) {
            return Data_Semigroup.append(Data_Time_Duration.semigroupMilliseconds)(Data_DateTime_Instant.unInstant(v.now))(v1);
          }($140(Data_DateTime_Instant.unInstant($141)));
        };
      }())(v.last);
    };
    ...
    var f = function f(v) {
      return function (v1) {
        ...
        if (v instanceof Press && v1 instanceof Lerp) {
          return new Lerp(0.0, new Data_List_Types.Cons(v1.value2, v1.value1), v.value0);
        }
        ...
        if (v instanceof Elapse && v1 instanceof Lerp) {
          ...
          if ($95) {
            return new Moves(new Data_List_Types.Cons(v1.value2, v1.value1));
          }
        ...
        ;
        throw new Error("Failed pattern match at Main (line 241, column 5 - line 241, column 53): " + [v.constructor.name, v1.constructor.name]);
      };
    };

    return FRP_Behavior.unfold(FRP_Event.eventIsEvent)(f)(pressOrElapse)(new Moves(Data_Monoid.mempty(Data_List_Types.monoidList)));
  };
};
...
var functionHyperSegment = new Data_Functor.Functor(function (f) {
  return function (m) {
    return {
      pointA: f(m.pointA),
      pointB: f(m.pointB)
...
var extend = function extend(v) {
  var isStraight = $$Math.abs(v.pointA.x * v.pointB.y - v.pointB.x * v.pointA.y) < 1.0e-14;
  ...
  ;
  throw new Error("Failed pattern match at Main (line 281, column 3 - line 283, column 57): " + [Data_Unit.unit.constructor.name]);
};
    ...
    return function (v) {
      ...
      if (v1 instanceof HCircle) {
        ...
        var beta = function () {
          ...
          ;
          throw new Error("Failed pattern match at Main (line 312, column 7 - line 315, column 30): " + []);
        }();
        ...
        var anticlockwise = function () {
          ...
          ;
          throw new Error("Failed pattern match at Main (line 318, column 7 - line 320, column 27): " + []);
        }();
      ...
      ;
      throw new Error("Failed pattern match at Main (line 296, column 77 - line 320, column 27): " + [v1.constructor.name]);
    };
  };
};
...
var drawFoo = function drawFoo(state) {
  return function __do() {
    ...
    var poly = centralPolygon(4)(5);
    var reflected = reflectPoint(extend(Data_Maybe.fromJust()(Data_List.index(poly.edges)(0))))(poly.center);
    var dist = hyperboloidDistance(p2h(poly.center))(p2h(reflected));

    var doTranslate = function doTranslate(moves) {
      var go = function go(v) {
        return function (acc) {
          if (v instanceof GoRight) {
            var $142 = hyperboloidTranslateX(dist);
            return function ($143) {
              return $142(acc($143));
            };
          }
          ...
          if (v instanceof GoLeft) {
            var $144 = hyperboloidTranslateX(-dist);
            return function ($145) {
              return $144(acc($145));
            };
          }
          ...
          if (v instanceof GoUp) {
            var $146 = hyperboloidTranslateY(dist);
            return function ($147) {
              return $146(acc($147));
            };
          }
          ...
          if (v instanceof GoDown) {
            var $148 = hyperboloidTranslateY(-dist);
            return function ($149) {
              return $148(acc($149));
            };
          }
          ...
          ;
          throw new Error("Failed pattern match at Main (line 160, column 11 - line 160, column 62): " + [v.constructor.name, acc.constructor.name]);
        };
      };

      return Data_Foldable.foldr(Data_List_Types.foldableList)(go)(function (x) {
        return x;
      })(moves);
    };

    var translationDistance = function translationDistance(hPt) {
      if (state instanceof Moves) {
        return doTranslate(state.value0)(hPt);
      }

      ;

      if (state instanceof Lerp) {
        var old = doTranslate(state.value1)(hPt);
        var $$new = doTranslate(new Data_List_Types.Cons(state.value2, state.value1))(hPt);
        return addV3(old)(scaleV3(state.value0)(addV3($$new)(scaleV3(-1.0)(old))));
      }

      ;
      throw new Error("Failed pattern match at Main (line 164, column 33 - line 169, column 40): " + [state.constructor.name]);
    };

    fillAndStrokePath(ctx)(function () {
      var translated = Data_Functor.map(Data_List_Types.functorList)(Data_Functor.map(functionHyperSegment)(function ($150) {
        return h2p(translationDistance(p2h($150)));
      }))(poly.edges);
      return Data_Traversable.traverse(Data_List_Types.traversableList)(Effect.applicativeEffect)(pathHyperSegment(ctx)(scale))(translated);
    }())();
    return Data_Unit.unit;
  };
};
...
var main = function __do() {
  ...
  var size = Data_Int.toNumber(Data_Ord.min(Data_Ord.ordInt)(windowHeight)(windowWidth));
  var canvas = Data_Functor.map(Effect.functorEffect)(Data_Maybe.fromJust())(Graphics_Canvas.getCanvasElementById("canvas"))();
...
module.exports = {
  ...
  functionHyperSegment: functionHyperSegment,
...
},{"./foreign.js":"../output/Main/foreign.js","../Control.Alt/index.js":"../output/Control.Alt/index.js","../Control.Bind/index.js":"../output/Control.Bind/index.js","../Data.Boolean/index.js":"../output/Data.Boolean/index.js","../Data.DateTime.Instant/index.js":"../output/Data.DateTime.Instant/index.js","../Data.Filterable/index.js":"../output/Data.Filterable/index.js","../Data.Foldable/index.js":"../output/Data.Foldable/index.js","../Data.Functor/index.js":"../output/Data.Functor/index.js","../Data.Generic.Rep/index.js":"../output/Data.Generic.Rep/index.js","../Data.Generic.Rep.Show/index.js":"../output/Data.Generic.Rep.Show/index.js","../Data.Int/index.js":"../output/Data.Int/index.js","../Data.List/index.js":"../output/Data.List/index.js","../Data.List.Types/index.js":"../output/Data.List.Types/index.js","../Data.Maybe/index.js":"../output/Data.Maybe/index.js","../Data.Monoid/index.js":"../output/Data.Monoid/index.js","../Data.Newtype/index.js":"../output/Data.Newtype/index.js","../Data.Ord/index.js":"../output/Data.Ord/index.js","../Data.Ring/index.js":"../output/Data.Ring/index.js","../Data.Semigroup/index.js":"../output/Data.Semigroup/index.js","../Data.Semiring/index.js":"../output/Data.Semiring/index.js","../Data.Show/index.js":"../output/Data.Show/index.js","../Data.Symbol/index.js":"../output/Data.Symbol/index.js","../Data.Time.Duration/index.js":"../output/Data.Time.Duration/index.js","../Data.Traversable/index.js":"../output/Data.Traversable/index.js","../Data.Unit/index.js":"../output/Data.Unit/index.js","../Effect/index.js":"../output/Effect/index.js","../Effect.Console/index.js":"../output/Effect.Console/index.js","../FRP.Behavior/index.js":"../output/FRP.Behavior/index.js","../FRP.Behavior.Time/index.js":"../output/FRP.Behavior.Time/index.js","../FRP.Event/index.js":"../output/FRP.Event/index.js","../FRP.Event.AnimationFrame/index.js":"../output/FRP.Event.AnimationFrame/index.js","../FRP.Event.Class/index.js":"../output/FRP.Event.Class/index.js","../FRP.Event.Keyboard/index.js":"../output/FRP.Event.Keyboard/index.js","../FRP.Event.Mouse/index.js":"../output/FRP.Event.Mouse/index.js","../FRP.Event.Touch/index.js":"../output/FRP.Event.Touch/index.js","../Graphics.Canvas/index.js":"../output/Graphics.Canvas/index.js","../Math/index.js":"../output/Math/index.js","../Web.Event.Event/index.js":"../output/Web.Event.Event/index.js","../Web.Event.EventTarget/index.js":"../output/Web.Event.EventTarget/index.js","../Web.HTML/index.js":"../output/Web.HTML/index.js","../Web.HTML.Window/index.js":"../output/Web.HTML.Window/index.js","../Web.TouchEvent.EventTypes/index.js":"../output/Web.TouchEvent.EventTypes/index.js","../Web.TouchEvent.Touch/index.js":"../output/Web.TouchEvent.Touch/index.js","../Web.TouchEvent.TouchEvent/index.js":"../output/Web.TouchEvent.TouchEvent/index.js","../Web.TouchEvent.TouchList/index.js":"../output/Web.TouchEvent.TouchList/index.js"}],"../index-dev.js":[function(require,module,exports) {
