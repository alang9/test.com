...
},{"../Data.Functor/index.js":"output/Data.Functor/index.js","../Data.Semigroup/index.js":"output/Data.Semigroup/index.js"}],"output/Data.DateTime.Instant/foreign.js":[function(require,module,exports) {
"use strict";
...
},{"./foreign.js":"output/Control.Bind/foreign.js","../Control.Apply/index.js":"output/Control.Apply/index.js","../Control.Category/index.js":"output/Control.Category/index.js","../Data.Function/index.js":"output/Data.Function/index.js"}],"output/Data.Enum/foreign.js":[function(require,module,exports) {
"use strict";
...
},{"./foreign.js":"output/Graphics.Canvas/foreign.js","../Control.Apply/index.js":"output/Control.Apply/index.js","../Data.Eq/index.js":"output/Data.Eq/index.js","../Data.Functor/index.js":"output/Data.Functor/index.js","../Data.Maybe/index.js":"output/Data.Maybe/index.js","../Data.Show/index.js":"output/Data.Show/index.js","../Effect/index.js":"output/Effect/index.js","../Effect.Exception.Unsafe/index.js":"output/Effect.Exception.Unsafe/index.js"}],"output/Main/index.js":[function(require,module,exports) {
// Generated by purs version 0.13.8
"use strict";
...
var scene = function scene(keyboard) {
  var timeElapsed = Data_Filterable.filterMap(FRP_Event.filterableEvent)(function (v) {
    return Data_Functor.map(Data_Maybe.functorMaybe)(function () {
      var $122 = Data_Time_Duration.negateDuration(Data_Time_Duration.durationMilliseconds);
      return function ($123) {
        return function (v1) {
          return Data_Semigroup.append(Data_Time_Duration.semigroupMilliseconds)(Data_DateTime_Instant.unInstant(v.now))(v1);
        }($122(Data_DateTime_Instant.unInstant($123)));
      };
    }())(v.last);
  })(FRP_Event_Class.withLast(FRP_Event.eventIsEvent)(FRP_Behavior.sample_(FRP_Event.eventIsEvent)(FRP_Behavior_Time.instant)(FRP_Event_AnimationFrame.animationFrame)));
  ...
  var pressOrElapse = Control_Alt.alt(FRP_Event.altEvent)(Control_Alt.alt(FRP_Event.altEvent)(leftArrow)(rightArrow))(Data_Functor.map(FRP_Event.functorEvent)(Elapse.create)(timeElapsed));
  ...
  var f = function f(v) {
    return function (v1) {
      ...
      ;
      throw new Error("Failed pattern match at Main (line 154, column 5 - line 154, column 59): " + [v.constructor.name, v1.constructor.name]);
    };
  };
...
var reflectPoint = function reflectPoint(v) {
  return function (v1) {
    ...
    ;
    throw new Error("Failed pattern match at Main (line 269, column 1 - line 269, column 38): " + [v.constructor.name, v1.constructor.name]);
  };
};
...
var extend = function extend(v) {
  ...
  ;
  throw new Error("Failed pattern match at Main (line 194, column 3 - line 196, column 57): " + [Data_Unit.unit.constructor.name]);
};
    ...
    return function (v) {
      ...
      if (v1 instanceof HCircle) {
        ...
        var beta = function () {
          ...
          ;
          throw new Error("Failed pattern match at Main (line 225, column 7 - line 228, column 30): " + []);
        }();
        ...
        var anticlockwise = function () {
          ...
          ;
          throw new Error("Failed pattern match at Main (line 231, column 7 - line 233, column 27): " + []);
        }();
      ...
      ;
      throw new Error("Failed pattern match at Main (line 209, column 77 - line 233, column 27): " + [v1.constructor.name]);
    };
  };
};
...
var drawFoo = function drawFoo(state) {
  return Data_Functor["void"](Effect.functorEffect)(function __do() {
    ...
    if (v instanceof Data_Maybe.Just) {
      ...
      var translationDistance = function () {
        if (state instanceof Num) {
          return dist * Data_Int.toNumber(state.value0);
        }

        ;

        if (state instanceof Lerp) {
          return dist * (Data_Int.toNumber(state.value1) + state.value0 * Data_Int.toNumber(state.value2 - state.value1 | 0));
        }

        ;
        throw new Error("Failed pattern match at Main (line 131, column 29 - line 133, column 77): " + [state.constructor.name]);
      }();

      return fillAndStrokePath(ctx)(Data_Traversable.traverse(Data_List_Types.traversableList)(Effect.applicativeEffect)(pathHyperSegment(ctx)(scale))(Data_Functor.map(Data_List_Types.functorList)(Data_Functor.map(functionHyperSegment)(function () {
        var $124 = hyperboloidTranslateX(translationDistance);
        return function ($125) {
          return h2p($124(p2h($125)));
        };
      }()))(poly.edges)))();
    }

    ;
    throw new Error("Failed pattern match at Main (line 115, column 3 - line 115, column 47): " + [v.constructor.name]);
  });
};
...
},{"./foreign.js":"output/Main/foreign.js","../Control.Alt/index.js":"output/Control.Alt/index.js","../Data.Boolean/index.js":"output/Data.Boolean/index.js","../Data.DateTime.Instant/index.js":"output/Data.DateTime.Instant/index.js","../Data.Eq/index.js":"output/Data.Eq/index.js","../Data.Filterable/index.js":"output/Data.Filterable/index.js","../Data.Functor/index.js":"output/Data.Functor/index.js","../Data.Generic.Rep/index.js":"output/Data.Generic.Rep/index.js","../Data.Generic.Rep.Show/index.js":"output/Data.Generic.Rep.Show/index.js","../Data.Int/index.js":"output/Data.Int/index.js","../Data.List/index.js":"output/Data.List/index.js","../Data.List.Types/index.js":"output/Data.List.Types/index.js","../Data.Maybe/index.js":"output/Data.Maybe/index.js","../Data.Monoid/index.js":"output/Data.Monoid/index.js","../Data.Newtype/index.js":"output/Data.Newtype/index.js","../Data.Ord/index.js":"output/Data.Ord/index.js","../Data.Ring/index.js":"output/Data.Ring/index.js","../Data.Semigroup/index.js":"output/Data.Semigroup/index.js","../Data.Semiring/index.js":"output/Data.Semiring/index.js","../Data.Show/index.js":"output/Data.Show/index.js","../Data.Symbol/index.js":"output/Data.Symbol/index.js","../Data.Time.Duration/index.js":"output/Data.Time.Duration/index.js","../Data.Traversable/index.js":"output/Data.Traversable/index.js","../Data.Unit/index.js":"output/Data.Unit/index.js","../Effect/index.js":"output/Effect/index.js","../Effect.Console/index.js":"output/Effect.Console/index.js","../FRP.Behavior/index.js":"output/FRP.Behavior/index.js","../FRP.Behavior.Time/index.js":"output/FRP.Behavior.Time/index.js","../FRP.Event/index.js":"output/FRP.Event/index.js","../FRP.Event.AnimationFrame/index.js":"output/FRP.Event.AnimationFrame/index.js","../FRP.Event.Class/index.js":"output/FRP.Event.Class/index.js","../FRP.Event.Keyboard/index.js":"output/FRP.Event.Keyboard/index.js","../FRP.Event.Mouse/index.js":"output/FRP.Event.Mouse/index.js","../Graphics.Canvas/index.js":"output/Graphics.Canvas/index.js","../Math/index.js":"output/Math/index.js","../Web.HTML/index.js":"output/Web.HTML/index.js"}],"index.js":[function(require,module,exports) {
...
//# sourceMappingURL=/sokyokuban.e31bb0bc.js.map